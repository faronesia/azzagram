$(document).ready(function () { 
  var license = $('#license-code').text(),
    ...
    if (myLicense == tpllc) {
        ...
        $('body').append('<style>body{background:#000!important;overflow:hidden}#peringatan span{font-size:50px}#peringatan{z-index:999999999;position:fixed;top:0;right:0;left:0;padding:20% 0;height:100%;text-align:center;background:#000;color:#fff}}</style><div id="peringatan"><h4>Activate Templates</h4><p>Anda tidak diperkenankan menggunakan template ini. Silahkan hubungi  <b>www.uangdunia.com</b> untuk mendapatkan lisensi Template</p><span id="aktivasi">'+second+'</span></div>');
...
var walink = 'https://web.whatsapp.com/send', 
    ...
    walink5 = 'Silahkan melakukan transfer melalui rekening yang sudah tersedia dengan nominal sesuai harga. Pengiriman followers dilakukan selama 2-24 jam tergantung banyaknya pesanan. Selama pengiriman, akun *TIDAK BOLEH* private.', 
    text_yes = 'Terkirim.', 
